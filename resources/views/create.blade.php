        ...
        <div class="max-w-md mx-auto bg-white shadow-md rounded-md p-6">
            ...
            <form action="{{ route('tasks.store') }}" method="post">
                ...
                <div class="flex justify-between items-center">
                    <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-500 border border-transparent rounded-md font-semibold text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Create Task</button>
                    <a href="{{ route('tasks.index') }}" class="text-gray-600 hover:text-blue-500">Cancel</a>
                </div>
            </form>
        </div>
    </div>
